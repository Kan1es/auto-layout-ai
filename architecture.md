...
1. Какой именно DART используется и какой формат результата он возвращает?
2. DART в текущей конфигурации поддерживает bbox, masks или оба режима?
3. Какие классы/объекты пользователь вводит через prompt: один класс или несколько?
4. Нужно ли автоматически создавать CVAT task через SDK или достаточно подготовить архив для ручного импорта?
5. Какой формат CVAT импорта выбран для bbox: YOLO, CVAT XML или другой?
6. Какой формат выбран для segmentation: COCO RLE, polygon или другой?
7. Нужно ли хранить несколько запусков DART или только последний результат?
8. Нужно ли делать остановку авторазметки во время выполнения?
9. Какой максимальный размер ZIP и максимальное число изображений допустимы для практики?
10. Qwen-блок действительно нужен в сдаче или остается дополнительной задачей?
